...
var doneTo = tryRequire( resolve( __dirname, './../lib/ndarray.native.js' ) );
var opts = {
	'skip': ( doneTo instanceof Error )
};
...
tape( 'the function has an arity of 4', opts, function test( t ) {
	t.strictEqual( doneTo.length, 4, 'has expected arity' );
	t.end();
});
